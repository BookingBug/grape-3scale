...
Gem::Specification.new do |s|
  ...
  s.authors = ["Ed Clements","Tim Vandecasteele"]
  s.date = "2013-08-02"
  s.description = "A simple way to add proper auto generated documentation - that can be displayed with 3scale Active Docs - to your inline described grape API"
  s.email = "ed@bookingbug.com"
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.markdown"
  ]
  ...
  s.homepage = "http://github.com/BookingBug/grape-3scale"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
